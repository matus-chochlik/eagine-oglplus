...
export module eagine.oglplus:result;
...
/// @see gl_no_result
/// @see gl_result_info
export class gl_no_result_info {
public:
...
public:
    ...
    constexpr auto error_code(const gl_types::enum_type ec) noexcept -> auto& {
        _error_code = ec;
        return *this;
    }
